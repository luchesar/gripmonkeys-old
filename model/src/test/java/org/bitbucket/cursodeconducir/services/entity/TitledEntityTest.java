...
public class TitledEntityTest {
	...
	public void testEqualsAndHashCode() throws Exception {
		...
		TitledEntity differentTitle = new TitledEntity("differentTitle",
				first.getTitleImage(), first.getDescription()) {
		};
		assertFalse(first.equals(differentTitle));
		assertFalse(first.hashCode() == differentTitle.hashCode());

		TitledEntity differentTitleImage = new TitledEntity(first.getTitle(),
				"different title image", first.getDescription()) {
		};
		assertFalse(first.equals(differentTitleImage));
		assertFalse(first.hashCode() == differentTitleImage.hashCode());

		TitledEntity differentImage = new TitledEntity(first.getTitle(),
				"different image", "differentDescription") {
		};
		assertFalse(first.equals(differentImage));
		assertFalse(first.hashCode() == differentImage.hashCode());

		TitledEntity differentDescription = new TitledEntity(first.getTitle(),
				first.getTitleImage(), "differentDescription") {
		};
		assertFalse(first.equals(differentDescription));
		assertFalse(first.hashCode() == differentDescription.hashCode());

		TitledEntity differentIsPublished = new TitledEntity(first.getTitle(),
				first.getTitleImage(), first.getDescription()) {
		};
		...
		TitledEntity same = new TitledEntity(first.getTitle(),
				first.getTitleImage(), first.getDescription()) {
		};
